...
5. **Mutation & Verification:** Apply your changes using your native file editing tool. Immediately after writing to disk, run `pnpm lint --fix`, `pnpm test`, and `pnpm build`. If either fails, resolve the errors autonomously before terminating.
